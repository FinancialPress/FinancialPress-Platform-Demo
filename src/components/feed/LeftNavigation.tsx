  ...
  return (
    <nav className={`sticky top-4 ${isDarkMode ? 'text-white' : 'text-black'}`}>
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center space-x-4 px-4 py-3 rounded-full transition-colors hover:${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'} ${
                item.active 
      ...
      <button
        ...
        className="w-full mt-6 bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-full transition-colors"
      >
