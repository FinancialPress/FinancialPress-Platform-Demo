...
const UserFeed = ({ onNavigate, isDarkMode, showOnboarding = false }: UserFeedProps) => {
  ...
  const buttonClasses = isDarkMode ? 'border-gray-600 text-gray-300 hover:bg-gray-700' : 'bg-white norder-b border-gray-200 text-gray-600 hobver:text-gray-600 hover:bg-gray-100';
