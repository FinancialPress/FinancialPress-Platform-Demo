...
import { Search, User, Sun, Moon, Menu, Settings as SettingsIcon, LogOut } from 'lucide-react';
...
const Header = ({
  ...
  return (
    <>
      ...
      <div className="w-full bg-[#FFD700] border-b border-yellow-600 hidden md:block">
            ...
            <div className="flex items-center space-x-2 sm:space-x-6">
              ...
              {shouldShowLoggedIn ? (
                <div className="flex items-center space-x-3 sm:space-x-4">
                  ...
                  {/* FPT Balance and Role Badge - Hidden on mobile */}
                  <div className="hidden sm:flex items-center space-x-3">
                    <div
                      className="flex items-center bg-[#FFD700] text-black px-2 py-1 rounded-full space-x-1 font-bold text-sm"
                    >
                      <span>💰</span>
