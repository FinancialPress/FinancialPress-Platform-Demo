      ...
      <div className="min-h-screen bg-black text-white">
        <div className="max-w-[1440px] mx-auto px-8 py-20">
          ...
          <div className="grid grid-cols-2 gap-12 max-w-6xl mx-auto">
            {/* Creator Path */}
            <Card className="bg-gray-900 border-gray-800 hover:border-yellow-500 transition-colors p-8 cursor-pointer"
            ...
            {/* Distributor Path */}
            <Card className="bg-gray-900 border-gray-800 hover:border-blue-500 transition-colors p-8 cursor-pointer"
      ...
      <div className="max-w-[1440px] mx-auto px-8 py-20">
        <div className="text-center mb-12">
          <Button
            variant="ghost"
            onClick={handleBack}
            className="absolute left-8 top-24 text-gray-400 hover:text-white"
          >
          ...
          <div className="flex items-center justify-center mb-6">
            <div className={`w-16 h-16 ${selectedRole === 'creator' ? 'bg-yellow-500' : 'bg-blue-500'} rounded-full flex items-center justify-center`}>
          ...
          <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-yellow-400 to-yellow-600 bg-clip-text text-transparent">
            Create Your {selectedRole === 'creator' ? 'Creator' : 'Distributor'} Account
          </h1>
          <p className="text-xl text-gray-300">
            {selectedRole === 'creator' 
              ? 'Start publishing and earning from your content'
              : 'Begin sharing and earning from quality content'
            }
          </p>
        </div>
